...
This repository is source-available for portfolio, review, and collaboration purposes only. No permission is granted to copy, modify, distribute, sublicense, sell, publish, host, or use this software or its assets in another product without prior written permission from the copyright holder.
